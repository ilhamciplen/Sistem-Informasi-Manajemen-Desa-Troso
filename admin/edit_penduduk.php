...
if (isset($_POST['update_penduduk'])) {
    ...
    $result = mysqli_query($mysqli, "UPDATE penduduk SET nik='$nik',no_kk='$no_kk',nama='$nama',tempat_lahir='$tempat_lahir',tgl_lahir='$lahir',status_kawin='$status_kawin',kewarganegaraan='$kewarganegaraan',rt='$rt',rw='$rw',pekerjaan='$pekerjaan' WHERE nik=$nik1");
...
$result = mysqli_query($mysqli, "SELECT * FROM penduduk WHERE nik=$nik");
...
while ($user_data = mysqli_fetch_array($result)) {
    ...
    $lahir = date('d-m-Y', strtotime($tgl_lahir));
    $status_kawin = $user_data['status_kawin'];
    $kewarganegaraan = $user_data['kewarganegaraan'];
    $rt = $user_data['rt'];
    $rw = $user_data['rw'];
                                ...
                                <div class="card-body">
                                    ...
                                    <form id="form" method="post" class="form_control">
                                        <div class="row">
                                            ...
                                            <div class="col-4">
                                                <label>No.KK :</label>
                                                <input placeholder="Masukkan KK" type="number" class="form-control" name="no_kk" maxlength="20" value=<?php echo $no_kk; ?> required>
                                            </div>
                                            <div class="col-5">
                                                <label>Nama :</label>
                                            ...
                                            <div class="col-3">
                                                ...
                                                <input placeholder="Masukkan Tempat Lahir" type="text" class="form-control" name="tempat_lahir" maxlength="20" value=<?php echo $tempat_lahir; ?> required>
                                            </div>
                                            <div class="col-4">
                                                <label>Tanggal lahir :</label>
                                                <input placeholder="Masukkan Tanggal Lahir" type="date" class="form-control" name="tgl_lahir" maxlength="20" value=<?php echo $tgl_lahir; ?> required>
                                            </div>
                                            <div class="col-5">
                                                <label>Status Kawin :</label>
                                                <input placeholder="Masukkan Status Kawin" type="text" class="form-control" name="status_kawin" maxlength="20" value=<?php echo $status_kawin; ?> required>
                                            </div>
                                            <div class="col-3">
                                                <label>Kewarganegaraan :</label>
                                                <input placeholder="Masukkan Kewarganegaraan" type="text" class="form-control" name="kewarganegaraan" maxlength="20" value=<?php echo $kewarganegaraan; ?> required>
                                            </div>
                                            <div class="col-4">
                                                <label>RT :</label>
                                            ...
                                            <div class="col-3">
                                                ...
                                                <input placeholder="Masukkan Pekerjaan" type="text" class="form-control" name="pekerjaan" maxlength="20" value=<?php echo $pekerjaan; ?> required>
                                            </div>
                                        </div>
                                        <div class="card-footer">
                                            <input type="submit" name="update_penduduk" class="submit" value="update penduduk">
                                        </div>
                                    </form>
