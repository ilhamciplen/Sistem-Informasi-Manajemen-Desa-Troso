                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <a href="insert_kegiatan.php" class="btn btn-primary">Tambah Data Baru</a>

                                    <form action="data_kegiatan.php" method="get" class="float-right d-none d-sm-inline-block">
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            if (isset($_GET['cari'])) {
                                                $cari = $_GET['cari'];
                                                $data = mysqli_query($mysqli, "SELECT A.id_kegiatan, A.nama_kegiatan, A.tgl_kegiatan, A.rt, A.rw, B.nama_desa FROM kegiatan A INNER JOIN desa B ON A.id_desa = B.id_desa  where nama_kegiatan like '%" . $cari . "%'");
                                            } else {

                                                $data = mysqli_query($mysqli, "SELECT A.id_kegiatan, A.nama_kegiatan, A.tgl_kegiatan, A.rt, A.rw, B.nama_desa FROM kegiatan A INNER JOIN desa B ON A.id_desa = B.id_desa ");
                                            }
                                            while ($user_data = mysqli_fetch_array($data)) {
                                                ...
                                                echo "<td>" . $user_data['tgl_kegiatan'] . "</td>";
                                                echo "<td>" . $user_data['rt'] . "</td>";
                                                echo "<td>" . $user_data['rw'] . "</td>";
                                                echo "<td>" . $user_data['nama_desa'] . "</td>";
                                            ?>
                                                <td align='center'><a href="edit_kegiatan.php?id_kegiatan=<?php echo $user_data['id_kegiatan']; ?>">Edit</a></td>
                                                <td align='center'><a href="hapus_kegiatan.php?id_kegiatan=<?php echo $user_data['id_kegiatan']; ?>">Delete</a></td>
                                                </tr>
                                            <?php
                                            }
                                            ?>
