    ...
    <div class="wrapper">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Data Kematian v1</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <a href="insert_kematian.php" class="btn btn-primary">Tambah Data Baru</a>

                                    <form action="data_kematian.php" method="get" class="float-right d-none d-sm-inline-block">
                                    ...
                                    <div class="card-body">
                                        <table id="example1" class="table table-bordered table-hover" role="grid" aria-describedby="example2_info">
                                            ...
                                            <tbody>
                                                ...
                                                if (isset($_GET['cari'])) {
                                                    $cari = $_GET['cari'];
                                                    $data = mysqli_query($mysqli, "SELECT A.no_kematian, A.nik, A.nama, A.tgl_kematian, A.tempat_kematian, A.penyebab, A.rt, A.rw, B.nama_desa FROM kematian A INNER JOIN desa B
     ...
     ON A.id_desa = B.id_desa ");
                                                ...
                                                while ($user_data = mysqli_fetch_array($data)) {
                                                    ...
                                                    echo "<tr>";
                                                    echo "<td>" . $user_data['no_kematian'] . "</td>";
                                                    echo "<td>" . $user_data['nik'] . "</td>";
                                                    echo "<td>" . $user_data['nama'] . "</td>";
                                                    echo "<td>" . $user_data['tgl_kematian'] . "</td>";
                                                    echo "<td>" . $user_data['tempat_kematian'] . "</td>";
                                                    echo "<td>" . $user_data['penyebab'] . "</td>";
                                                ...
                                                ?>
                                                    ...
                                                    <td align='center'><a href="edit_kematian.php?no_kematian=<?php echo $user_data['no_kematian']; ?>">Edit</a></td>
                                                    <td align='center'><a href="hapus_kematian.php?no_kematian=<?php echo $user_data['no_kematian']; ?>">Delete</a></td>
                                                    </tr>
