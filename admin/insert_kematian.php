                        ...
                        <div class="col-12">
                            <div class="card card-danger">
                                ...
                                <div class="card-body">
                                    ...
                                    <form id="form" method="post" action="tambah_kematian.php?user=<?php echo $user; ?>">
                                        <div class="row">
                                            <div class="col-3">
                                                <label>No Kematian:</label>
                                                <input placeholder="Masukkan Nomor Kematian" type="number" class="form-control" name="no_kematian" maxlength="20" required>
                                            </div>
                                            <div class="col-4">
                                                <label>NIK :</label>
                                            ...
                                            <div class="col-3">
                                                ...
                                                <input placeholder="Masukkan Tanggal Meninggal" type="date" class="form-control" name="tgl_kematian" maxlength="20" required>
                                            </div>
                                            <div class="col-4">
                                                <label>Tempat Meninggal :</label>
                                                <input placeholder="Masukkan Tempat Meninggal" type="text" class="form-control" name="tempat_meninggal" maxlength="20" required>
                                            </div>
                                            <div class="col-5">
                                                <label>Penyebab :</label>
                                                <input placeholder="Masukkan Penyebab" type="text" class="form-control" name="penyebab" maxlength="20" required>
                                            </div>
                                            <div class="col-3">
                                                <label>RT :</label>
