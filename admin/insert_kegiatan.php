                        ...
                        <div class="col-12">
                            <div class="card card-danger">
                                ...
                                <div class="card-body">
                                    ...
                                    <form id="form" method="post" action="tambah_kegiatan.php?user=<?php echo $user; ?>">
                                        <div class="row">
                                            <div class="col-3">
                                                <label>ID Kegiatan :</label>
                                                <input placeholder="Masukkan ID Kegiatan" type="number" class="form-control" name="id_kegiatan" maxlength="20" required>
                                            </div>
                                            <div class="col-4">
                                                <label>Nama Kegiatan :</label>
                                                <input placeholder="Masukkan Nama Kegiatan" type="text" class="form-control" name="nama_kegiatan" maxlength="100" required>
                                            </div>
                                            <div class="col-5">
                                                <label>Tanggal Pelaksanaan :</label>
                                                <input placeholder="Masukkan Tanggal" type="date" class="form-control" name="tgl_kegiatan" maxlength="20" required>
                                            </div>
                                            <div class="col-3">
                                                <label>RT :</label>
